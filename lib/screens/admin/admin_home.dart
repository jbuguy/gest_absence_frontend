    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(
            icon: Icon(Icons.school_outlined, color: theme.colorScheme.onSurfaceVariant),
          ...
          NavigationDestination(
            icon: Icon(Icons.class_outlined, color: theme.colorScheme.onSurfaceVariant),
            selectedIcon: Icon(Icons.class_, color: theme.colorScheme.primary),
            label: 'Classes',
          ),
          NavigationDestination(
            icon: Icon(Icons.calendar_today_outlined, color: theme.colorScheme.onSurfaceVariant),
